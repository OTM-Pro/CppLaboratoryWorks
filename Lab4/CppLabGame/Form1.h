...
namespace CppCLRWinformsProjekt {
	...
	public:
		Form1(void)
		{
			...
			for (int i = 0; i < 12; i++)
			{
				String^ fileName = "D:\\Desktop\\Sprites\\" + System::Convert::ToString(i) + ".bmp";
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			// menuStrip1
			// 
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->newGameToolStripMenuItem });
